...
<div class="container-fluid container-web-page border-bottom bg-white">
    ...
    <div class="row">
        <div class="col-12 col-sm-6 col-md-4">
            <p class="text-center"><em class="fas fa-shipping-fast fa-5x"></em></p>
            <h5 class="text-center text-uppercase poppins-regular font-weight-bold">Envíos a domicilio</h5>
            <p class="text-center">Registrate y crea tu pedido que nosotros te lo llevamos hasta tu casa.</p>
        </div>
        <div class="col-12 col-sm-6 col-md-4">
            <p class="text-center"><em class="fas fa-boxes fa-5x"></em></p>
            <h5 class="text-center text-uppercase poppins-regular font-weight-bold">Ventas al por mayor</h5>
            <p class="text-center">Te ofrecemos excelentes productos a los mejores precios  TENEMOS PROMOCIONES PARA TI.</p>
        </div>
        <div class="col-12 col-sm-6 col-md-4">
            <p class="text-center"><em class="fas fa-store-alt fa-5x"></em></p>
            <h5 class="text-center text-uppercase poppins-regular font-weight-bold">Retiro en tienda</h5>
            <p class="text-center">Te invitamos a que hagas tu pedido y lo recojas en nuestra tienda y asi te antojas de algo mas </p>
        </div>
    </div>
</div>
