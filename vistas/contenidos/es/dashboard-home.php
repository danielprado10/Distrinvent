...
<div class="full-box tile-container">
    ...
    <a href="<?php echo SERVERURL.DASHBOARD; ?>/product-list/" class="tile">
        ...
        <div class="tile-icon">
            <em class="fas fa-box-open fa-fw"></em>
    ...
    <a href="<?php echo SERVERURL.DASHBOARD; ?>/admin-list/" class="tile">
        ...
        <div class="tile-icon">
            <em class="fas fa-user-secret fa-fw"></em>
    ...
    <a href="#" class="tile">
        ...
        <div class="tile-icon">
            <em class="fas fa-truck-loading fa-fw"></em>
    ...
    <a href="#" class="tile">
        ...
        <div class="tile-icon">
            <em class="fas fa-file-invoice-dollar fa-fw"></em>
            <p>&nbsp;</p>
        </div>
    </a>
