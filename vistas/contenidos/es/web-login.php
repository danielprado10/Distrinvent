    ...
    <div class="login-content">
        ...
        <form action="" method="POST" autocomplete="off">
            <div class="form-outline mb-4">
                ...
                <label for="login_usuario" class="form-label"><em class="fas fa-user-secret"></em> &nbsp; Usuario</label>
            </div>
            <div class="form-outline mb-4">
                ...
                <label for="login_clave" class="form-label"><em class="fas fa-key"></> &nbsp; Contraseña</label>
            </div>
