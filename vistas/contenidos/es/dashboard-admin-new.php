...
<div class="full-box page-header">
    <h3 class="text-start roboto-condensed-regular text-uppercase">
        <em class="fas fa-plus fa-fw"></em> &nbsp; Nuevo administrador
    </h3>
</div>
...
<div class="container-fluid">
    <ul class="nav nav-tabs nav-justified mb-4" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" href="<?php echo SERVERURL.DASHBOARD; ?>/admin-new/" ><em class="fas fa-plus fa-fw"></em> &nbsp; Nuevo administrador</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" href="<?php echo SERVERURL.DASHBOARD; ?>/admin-list/" ><em class="fas fa-clipboard-list fa-fw"></em> &nbsp; Lista de administradores</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" href="<?php echo SERVERURL.DASHBOARD; ?>/admin-search/" ><em class="fas fa-search fa-fw"></em> &nbsp; Buscar administrador</a>
        </li>
    </ul>
</div>
...
<div class="container-fluid">
    <form class="dashboard-container FormularioAjax" method="POST" data-form="save" data-lang="<?php echo LANG; ?>" autocomplete="off" action="<?php echo SERVERURL;?>ajax/administradorAjax.php">
        ...
        <fieldset class="mb-4">
            <legend><em class="far fa-address-card"></em> &nbsp; Información personal</legend>
            <div class="container-fluid">
                <div class="row">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <legend><em class="fas fa-female"></em> <em class="fas fa-male"></em> &nbsp; Genero</legend>
                        <div class="mb-4">
                    ...
                    <div class="col-12 col-md-6">
                        <legend><em class="fas fa-user-secret"></em> &nbsp; Cargo</legend>
                        <div class="mb-4">
                            <div class="form-check mb-2">
        ...
        <fieldset class="mb-4">
            <legend><em class="fas fa-user-lock"></em> &nbsp; Datos de la cuenta</legend>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-outline mb-4">
        ...
        <fieldset class="mb-4">
            <legend><em class="fas fa-user-circle"></> &nbsp; Avatar</legend>
            <div class="container-fluid">
                <div class="row">
                    <?php 
        ...
        <p class="text-center" style="margin-top: 40px;">
            <button type="submit" class="btn btn-primary"><em class="far fa-save"></em> &nbsp; GUARDAR</button>
        </p>
        <p class="text-center">
