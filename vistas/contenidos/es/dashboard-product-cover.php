...
<div class="full-box page-header">
    <h3 class="text-start roboto-condensed-regular text-uppercase">
        <em class="fas fa-plus fa-fw"></em> &nbsp; Agregar producto
    </h3>
</div>
...
<div class="container-fluid">
    <ul class="nav nav-tabs nav-justified mb-4" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link" href="<?php echo SERVERURL.DASHBOARD; ?>/product-new/" ><em class="fas fa-plus fa-fw"></em> &nbsp; Agregar producto</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" href="<?php echo SERVERURL.DASHBOARD; ?>/product-list/" ><em class="fas fa-boxes fa-fw"></em> &nbsp; Inventario de productos</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" href="<?php echo SERVERURL.DASHBOARD; ?>/product-minimum/" ><em class="fas fa-stopwatch-20 fa-fw"></em> &nbsp; Productos en stock mínimo</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" href="<?php echo SERVERURL.DASHBOARD; ?>/product-search/" ><em class="fas fa-search fa-fw"></em> &nbsp; Buscar producto</a>
        </li>
    </ul>
</div>
            ...
            <div class="row">
                    ...
                    <?php if(is_file("./vistas/assets/product/cover/".$campos['producto_portada'])){ ?>
                        <form class="FormularioAjax" data-lang="<?php echo LANG; ?>" action="<?php echo SERVERURL; ?>ajax/productoAjax.php" method="POST" data-form="delete" autocomplete="off" >
                            ...
                            <p class="text-center" style="margin-top: 40px;">
                                ...
                                <em class="far fa-trash-alt"></em> &nbsp; ELIMINAR IMAGEN</button>
                            </p>
                        </form>
                    <?php }else{ ?>
                        <figure>
                ...
                <div class="col-12 col-md-6">
                    <form class="FormularioAjax dashboard-container" data-lang="<?php echo LANG; ?>" action="<?php echo SERVERURL; ?>ajax/productoAjax.php" method="POST" data-form="update" autocomplete="off" enctype="multipart/form-data" >
                        ...
                        <fieldset>
                            <legend><em class="far fa-file-image"></em> &nbsp; Foto o portada de producto</legend>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="text-center" style="margin-top: 40px;">
                                            <button type="submit" class="btn btn-success btn-sm"><em class="fas fa-sync"></em> &nbsp; ACTUALIZAR IMAGEN</button>
                                        </p>
                                    </div>
                                </div>
                            </div>
