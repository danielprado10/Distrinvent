    ...
    <div class="login-content mb-4">
        ...
        <form action="" method="POST" autocomplete="off">
            <div class="form-outline mb-4">
                ...
                <label for="login_email" class="form-label"><em class="fas fa-envelope-open-text"></em> &nbsp; Email</label>
            </div>
            <div class="form-outline mb-4">
                <input type="password" class="form-control" id="login_clave" name="login_clave" pattern="[a-zA-Z0-9$@.-]{7,100}" maxlength="100" required="" >
                <label for="login_clave" class="form-label"><em class="fas fa-key"></em> &nbsp; Contraseña</label>
            </div>
